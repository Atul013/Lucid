...
| Budget alerts in Morning Briefing | 👀 In Review | Am4l-babu | feature/budget-briefing | Same pattern as Twin x Briefing: surface subscription waste + next-month cash-flow forecast from /finance/summary as a third stat card on /today (PR #54) |
